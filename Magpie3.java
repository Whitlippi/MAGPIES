...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Ms. Kelly") >= 0)
		{
		...
		else if (findKeyword(statement, "changed the IP") >= 0
				|| findKeyword(statement,"changed the I.P.") >= 0
				|| findKeyword(statement,"changed the ip") >= 0)
		{
			response = "It was Malcom! ;)";
		}
		else if (findKeyword(statement,"Based God") >= 0)
		{
